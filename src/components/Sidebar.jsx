...
const Sidebar = ({ isOpen, toggle }) => {
  ...
  const hourlyStayMenuItems = [
    { to: "/hourlystay-RoomStatus", text: "Dashboard", icon: RoomstatusIcon },
    { to: "/hourlystay-Page", text: "Hourly Stays", icon: hotelicon },
    { to: "/hourlystay-Rooms", text: "Rooms", icon: roomsicon },
    { to: "/hourlystay-GuestDetails", text: "Guest Details", icon: locationicon },
    { to: "/hourlystay-Payments", text: "Payments", icon: rupees },
    { to: "/hourlystay-Reviews", text: "Reviews", icon: Reviewicon },
    { to: "/hourlystay", text: "User Profile", icon: usericon },
  ]
    ...
    <>
      ...
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <div className="logo text-center justify-content-center">
          <img className="text-center mb-5  " style={{height:"160px"}} src={logo || "/placeholder.svg"} alt="" />
        </div>
